...
class user():
    ...
    def inform_facet(self, facet):
        ...
        if facet in ['stars']:
            ...
            ground_truth_feature = cfg.item_dict[str(self.busi_id)]['categories']
    ...
    def response(self, input_message):
        ...
        if input_message.message_type == cfg.MAKE_REC:
            ...
            rec_list = [cfg.item_dict[str(i)]['busi_id'] for i in rec_list]
            rec_name_list = [cfg.busi_name[str(i)].encode('utf-8') for i in rec_list]
            rec_list = input_message.data['rec_list']
            ...
            if input_message.data['itemID'] not in rec_list:
                ...
                data['ranking'] = 1
                data['total'] = 1
                data['position'] = rec_list.index(input_message.data['itemID'])
