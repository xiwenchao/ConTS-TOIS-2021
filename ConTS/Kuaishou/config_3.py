...
class _Config():
    ...
    def init_basic(self):
        with open('../../data/FM-train-data 3/review_dict_train.json', 'r') as f:
            self._train_user_to_items = json.load(f)
        with open('../../data/FM-train-data 3/review_dict_valid.json', 'r') as f:
            self._valid_user_to_items = json.load(f)
        with open('../../data/FM-train-data 3/review_dict_test.json', 'r') as f:
            self._test_user_to_items = json.load(f)
        with open('../../data/FM-train-data 3/FM_busi_list.pickle', 'rb') as f:
            self.busi_list = pickle.load(f)
        with open('../../data/FM-train-data 3/FM_user_list.pickle', 'rb') as f:
            self.user_list = pickle.load(f)
        with open('../../data/FM-train-data 3/FM_train_list.pickle', 'rb') as f:
            self.train_list = pickle.load(f)
        with open('../../data/FM-train-data 3/FM_valid_list.pickle', 'rb') as f:
            self.valid_list = pickle.load(f)
        with open('../../data/FM-train-data 3/FM_test_list.pickle', 'rb') as f:
        ...
        with open('../../data/FM-train-data 3/item_dict-merge.json', 'r') as f:
    ...
    def init_misc(self):
        ...
        self.FACET_POOL = [i for i in range(666)]
