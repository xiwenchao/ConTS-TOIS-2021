...
class _Config():
    ...
    def init_basic(self):
        with open('../../data/FM-train-data 2/review_dict_train.json', 'r') as f:
            self._train_user_to_items = json.load(f)
        with open('../../data/FM-train-data 2/review_dict_valid.json', 'r') as f:
            self._valid_user_to_items = json.load(f)
        with open('../../data/FM-train-data 2/review_dict_test.json', 'r') as f:
            self._test_user_to_items = json.load(f)
        with open('../../data/FM-train-data 2/FM_busi_list.pickle', 'rb') as f:
            self.busi_list = pickle.load(f)
        with open('../../data/FM-train-data 2/FM_user_list.pickle', 'rb') as f:
            self.user_list = pickle.load(f)
        with open('../../data/FM-train-data 2/FM_train_list.pickle', 'rb') as f:
            self.train_list = pickle.load(f)
        with open('../../data/FM-train-data 2/FM_valid_list.pickle', 'rb') as f:
            self.valid_list = pickle.load(f)
        with open('../../data/FM-train-data 2/FM_test_list.pickle', 'rb') as f:
        ...
        for i in range(len(self.train_list)):
             u, item = self.train_list[i]
             user_id = int(u)
             if user_id >= self.old_users:
                 self.test_list.append([u, item])

        for i in range(len(self.test_list_2)):
             u, item = self.test_list_2[i]
             user_id = int(u)
             if user_id >= self.old_users:
                 self.test_list.append([u, item])

        for i in range(len(self.valid_list)):
             u, item = self.valid_list[i]
             user_id = int(u)
             if user_id >= self.old_users:
                 self.test_list.append([u, item])
        ...
        with open('../../data/FM-train-data 2/item_map-merge.json', 'r') as f:
            self.item_map = json.load(f)
        with open('../../data/FM-train-data 2/user_map.json', 'r') as f:
            self.user_map = json.load(f)
        with open('../../data/FM-train-data 2/city_map.json', 'r') as f:
            self.city_map = json.load(f)
        with open('../../data/FM-train-data 2/tag_map-new.json', 'r') as f:
            self.tag_map = json.load(f)
        with open('../../data/FM-train-data 2/2-layer-tax-v2.json', 'r') as f:
            self.taxo_dict = json.load(f)

        # print('feature = {}'.format(self.taxo_dict))
        ...
        with open('../../data/FM-train-data 2/item_dict.json', 'r') as f:
            self.item_dict = json.load(f)


        with open('../../data/FM-train-data 2/busi_name.json', 'r') as f:
    ...
    def init_misc(self):
        ...
        self.FACET_POOL = [i for i in range(33)]
